...
class ActionType2(ActionType):
    ...
    def execute(self, mesh, boundary, reference_vertex_V0_idx, new_vertex_V2_coords, new_vertex_V3_coords):
        ...
        Args:
            ...
            new_vertex_V3_coords: 新顶点V3的坐标(x, y)
        ...
        V2 = tuple(new_vertex_V2_coords)  # 第一个新添加的顶点
        V3 = tuple(new_vertex_V3_coords)  # 第二个新添加的顶点
        ...
        new_mesh.add_edge(V3, V0)  # 新的边界边

        # 更新边界：移除旧的边界边 (V0-V1)，添加新的边界边
        # 移除顶点V1
        ...
        if v0_idx is not None:
            ...
            new_boundary.insert_vertex(V3, v0_idx + 2)
