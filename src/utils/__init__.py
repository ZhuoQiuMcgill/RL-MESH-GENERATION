# 直接导入不会造成循环依赖的模块
from .angle import euclidean_distance, get_interior_angle, is_angle_in_slice, calculate_base_length, normalize_coordinates, calculate_polygon_area
