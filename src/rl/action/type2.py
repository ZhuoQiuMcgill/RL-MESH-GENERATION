...
class ActionType2(ActionType):
    ...
    def get_generated_angle(self, boundary, reference_vertex_idx, *coords):
        [v0, v3, v2, v1] = self.get_element(boundary, reference_vertex_idx, coords[0], coords[1])
        angle_1 = [v3, v0, boundary.get_vertex_by_index(reference_vertex_idx + 1)]
    ...
    def execute(self, mesh, boundary, reference_vertex_idx, *coords):
        ...
        """
        quadrilateral = self.get_element(boundary, reference_vertex_idx, coords[0], coords[1])
    ...
    def get_boundary_quality(self, boundary, reference_vertex_idx, *coords, M_angle):
        a1, a2 = self.get_generated_angle(boundary, reference_vertex_idx, coords[0], coords[1])
