...
const Layout = ({ children }) => {
  ...
  // For predict page, render layout with header but fullscreen main area
  if (isPredict) {
    return (
          ...
          <div style={{
            ...
            {!isMobile && (
              <>
                ...
                }}>Generate optimized mesh structures using trained reinforcement learning models</p>
              </>
            )}
            
          </div>
          
          {/* Right side - Theme toggle and Dashboard link */}
          <div style={{
            display: 'flex',
            alignItems: 'center',
            gap: '0.75rem'
            ...
            {/* Dashboard link - moved to rightmost position */}
            <Link
              to="/"
              style={{
                display: 'flex',
              ...
              onMouseEnter={(e) => {
                const hoverColor = isDark ? '#60a5ff' : '#030067';
                e.target.style.color = hoverColor;
                e.target.style.background = isDark ? 'rgba(96, 165, 255, 0.1)' : 'rgba(3, 0, 103, 0.08)';
                e.target.style.borderColor = isDark ? 'rgba(96, 165, 255, 0.4)' : 'rgba(3, 0, 103, 0.3)';
              }}
              onMouseLeave={(e) => {
                e.target.style.color = isDark ? '#a0aec0' : '#6b7280';
                e.target.style.background = 'transparent';
                e.target.style.borderColor = 'rgba(3, 0, 103, 0.2)';
              }}
            >
  ...
  // Modern layout for all other pages
  return (
    <div className="app" style={{ 
      background: isDark ? '#0f1419' : '#ffffff',
      minHeight: '100vh',
      ...
      <header style={{
        ...
        {/* Right side - Theme toggle and Dashboard link for non-dashboard pages */}
        <div style={{
          display: 'flex',
          alignItems: 'center',
          gap: '0.75rem'
          ...
          {/* Dashboard link for non-dashboard pages - moved to rightmost position */}
